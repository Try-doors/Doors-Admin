...
import { Building2, CalendarCheck, Crown, House, User, Users } from 'lucide-react'
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[240px] shrink-0 border-r border-[#E2E4E9] bg-white">
      <div className="flex h-[72px] items-center px-[26px]">
        <img src={doorsLogoMark} alt="" className="h-[17px] w-[17px]" />
        <p className="ml-[4.66px] text-[19px] font-semibold tracking-[-0.77px] text-black">doors</p>
      </div>
